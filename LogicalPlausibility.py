...
class LogicalPlausibility:
    ...
    def load_facts(self, file='facts.json', start="1000-01-01 00:00:00", end="9999-12-31 23:59:59"):
        script_dir = os.path.dirname(__file__)  # <-- absolute dir the script is in
    ...
    def check_plausibility(self, experiment_number, period_start="2023-03-13 00:00:00", period_end="2023-03-26 23:59:59", database_root="DataBases", results_root="Results", test=True):
        ...
        facts_string, fact_list = self.load_facts(f'facts_from_ml_sensors_finetuned_{experiment_number}.json', "2023-03-13 00:00:00", "2023-03-26 23:59:59")
